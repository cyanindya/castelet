...
##					them using CasteletDissolveMaterialListResource resource.
...
func _pixelate_screen(old_widget : Texture2D = null, _new_widget : Texture2D = null, args={}):
	...
	if shape == "hex":
		pixellateMaterial = load("res://castelet/castelet_core/shaders/two_texture_hexagon_pixelate_shader.tres")
	else:
		pixellateMaterial = load("res://castelet/castelet_core/shaders/two_texture_pixelate_shader.tres")
...
func _wipe_screen(old_widget : Texture2D = null, new_widget : Texture2D = null, args={}):
	...
	linearWipeMaterial = load("res://castelet/castelet_core/shaders/two_texture_linear_wipe_shader.tres")
...
func _slide_screen(old_widget : Texture2D = null, new_widget : Texture2D = null, args={}):
	...
	slideMaterial = load("res://castelet/castelet_core/shaders/two_texture_slide_shader.tres")
...
func _load_dissolve_presets(file_name : String):
	...
	# then check if it is a CasteletDissolveMaterialListResource.
	#
	...
	if file_name.ends_with(".tres"):
		...
		if res is CasteletDissolveMaterialListResource:
